...
//        setDiscriminator("bs");
    ...
    public BuisnessCustomerDTO(String lastname, String firstname, String discription, String companyName) {
        super(lastname, firstname, discription);
        setCompanyName(companyName);
    }


    public BuisnessCustomerDTO(CustomerDTO advicer, String lastname, String firstname, String discription, String companyName) {
        super(advicer, lastname, firstname, discription);
        this.companyName = companyName;
    }
}
